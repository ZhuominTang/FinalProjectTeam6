...
public class DeliveryAgentJPanel extends javax.swing.JPanel {
       ...
       DefaultTableModel dtm = (DefaultTableModel) ManageDeliveryManTable1.getModel();
        ...
        for (Organization org : enterprise.getOrganizationDirectory().getOrganizationList()) {
            ...
            if (org instanceof DeliveryManOrganization) {
                DeliveryManOrganization dmo = (DeliveryManOrganization) org;
                Object[] row = new Object[3];
                row[0] = org;
                row[1] = dmo.getAddress();
                row[2] = dmo.getPhoneNumber();
                dtm.addRow(row);
    ...
    public void populateDriver() {
        ...
        for (Organization org : enterprise.getOrganizationDirectory().getOrganizationList()) {
            ...
            if (org instanceof DriverOrganization) {
                DriverOrganization driverO = (DriverOrganization) org;
                Object[] row = new Object[3];
                row[0] = org;
                row[1] = driverO.getAddress();
                row[2] = driverO.getPhoneNumber();
                dtm.addRow(row);
    ...
    private void initComponents() {
        ...
        DriverWorkPane.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        DriverWorkPane.setLayout(new java.awt.CardLayout());
        ...
        RemovejButton3.setFont(new java.awt.Font("Lucida Bright", 0, 14)); // NOI18N
        RemovejButton3.setText("Remove Driver");
        RemovejButton3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                RemovejButton3ActionPerformed(evt);
            }
        });
        ...
        ManageDriverjPanelLayout.setHorizontalGroup(
            ...
            .addGroup(ManageDriverjPanelLayout.createSequentialGroup()
                ...
                .addGroup(ManageDriverjPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(DriverWorkPane, javax.swing.GroupLayout.PREFERRED_SIZE, 340, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(ManageDriverjPanelLayout.createSequentialGroup()
                        .addComponent(createButton1, javax.swing.GroupLayout.PREFERRED_SIZE, 161, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(RemovejButton3, javax.swing.GroupLayout.PREFERRED_SIZE, 1, Short.MAX_VALUE)))
                .addContainerGap(14, Short.MAX_VALUE))
        );

        ManageDriverjPanelLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {RemovejButton3, createButton1});
                ...
                .addGroup(ManageDriverjPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(ManageDriverjPanelLayout.createSequentialGroup()
                        .addGroup(ManageDriverjPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(RemovejButton3, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(DriverWorkPane, javax.swing.GroupLayout.PREFERRED_SIZE, 435, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(108, Short.MAX_VALUE))
        );

        ManageDriverjPanelLayout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {RemovejButton3, createButton1});
        ...
        DeliveryManWorkPanel.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        DeliveryManWorkPanel.setLayout(new java.awt.CardLayout());
        ...
        RemovejButton4.setFont(new java.awt.Font("Lucida Bright", 0, 14)); // NOI18N
        RemovejButton4.setText("Remove DeliveryMan");
        RemovejButton4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
            ...
            .addGroup(ManageDelivertManJPanelLayout.createSequentialGroup()
                ...
                .addGroup(ManageDelivertManJPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(ManageDelivertManJPanelLayout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(RemovejButton4, javax.swing.GroupLayout.PREFERRED_SIZE, 179, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(DeliveryManWorkPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 340, javax.swing.GroupLayout.PREFERRED_SIZE))
            ...
            .addGroup(ManageDelivertManJPanelLayout.createSequentialGroup()
                ...
                .addGroup(ManageDelivertManJPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(ManageDelivertManJPanelLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(DeliveryManWorkPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 435, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(108, Short.MAX_VALUE))
        );
    ...
    private void createButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createButton1ActionPerformed
        this.DriverWorkPane.removeAll();
        CreateDriverJPanel ep = new CreateDriverJPanel(this.system, this, this.DriverWorkPane, this.enterprise);
        this.DriverWorkPane.add(ep);
        CardLayout layout = (CardLayout) this.DriverWorkPane.getLayout();
        layout.next(this.DriverWorkPane);
    ...
    private void createButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createButton2ActionPerformed
        // TODO add your handling code here:
        this.DeliveryManWorkPanel.removeAll();
        CreateDeliveryManJPanel ep = new CreateDeliveryManJPanel(this.system, this, this.DeliveryManWorkPanel, this.enterprise);
        this.DeliveryManWorkPanel.add(ep);
        CardLayout layout = (CardLayout) this.DeliveryManWorkPanel.getLayout();
        layout.next(this.DeliveryManWorkPanel);
    }//GEN-LAST:event_createButton2ActionPerformed

    private void RemovejButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RemovejButton3ActionPerformed
 int selectedRow = ManageDriverTable.getSelectedRow();
        ...
        Organization org = (Organization) ManageDriverTable.getValueAt(selectedRow, 0);
        enterprise.getOrganizationDirectory().getOrganizationList().remove(org);
       populateDriver();     // TODO add your handling code here:
    }//GEN-LAST:event_RemovejButton3ActionPerformed
 ...
 int selectedRow = ManageDeliveryManTable1.getSelectedRow();
        ...
        Organization org = (Organization) ManageDeliveryManTable1.getValueAt(selectedRow, 0);
        enterprise.getOrganizationDirectory().getOrganizationList().remove(org);
         populateDeliveryMan();       // TODO add your handling code here:
    ...
    private javax.swing.JPanel DeliveryManWorkPanel;
    private javax.swing.JPanel DriverWorkPane;
    ...
    private javax.swing.JButton RemovejButton3;
