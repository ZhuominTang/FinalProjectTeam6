...
private EcoSystem system;
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        // TODO add your handling code here:
        String DriverName = NamejTextField.getText();
        String phoneNumber = PhoneNumberjTextField.getText();
        String address = AddressjTextField.getText();
        String userName = UserNamejTextField.getText();
        String password = String.valueOf(passwordJPasswordField.getPassword());
        if (DriverName.trim().equals("") || phoneNumber.trim().equals("") || address.trim().equals("") || userName.trim().equals("")
        ...
        Organization org = enterprise.getOrganizationDirectory().createOrganization(Organization.Type.Driver);
        DriverOrganization driverO = (DriverOrganization)org;
        driverO.setName(DriverName);
        driverO.setAddress(address);
        driverO.setPhoneNumber(phoneNumber);
        driverO.getUserAccountDirectory().createUserAccount(userName, password, new Employee(), new Driver());
