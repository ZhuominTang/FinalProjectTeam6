...
public class MainJFrame extends javax.swing.JFrame {
    ...
    DistributionCenterDirectory distributionCenterDirectory;
    ...
    public MainJFrame(EcoSystem system, UserAccount account, Enterprise enterprise, Organization organization) {
       ...
       // container.add("workArea", account.getRole().createWorkArea( container,account,organization,enterprise,system,this));
         container.add("workArea", account.getRole().createWorkArea( container,account,organization,enterprise,system,this, driverDirectory, distributionCenterDirectory, deliveryManDirectory));
